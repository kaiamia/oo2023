...
//* Koosta uus Spring rakendus. Koosta klass toiduaine tarbeks (nimetus, valkude, rasvade ja süsivesikute protsent).
// Loo API otspunkti kaudu - loodava instantsi protsent kokku ei saa ületada 100 - muidu antakse veateade.
// Loo mõni toiduaine (nt. kartul, hapukoor, vorst). Koosta klass toidukomponendi tarbeks (kogus, viit toiduainele).
...
//* Koosta uus klass, kus on toiduainete listid ning kus saab toiduaineid objektide API otspunktide kaudu lisada ja kustutada,
// nime järgi andmeid vaadata ning rasvaprotsendivahemiku järgi otsida.
//* Koosta klass toidu jaoks (nimetus, toidukomponendid). Toidule käsklused küsimaks sisalduvate valkude, rasvade ja süsivesikute kogust.
// Loo retsepti järgi toit (nt. kartulisalat), küsi salatis leiduvate toitainete kogused. Koosta klass,
// kus näidatakse valitud toidu etteantud koguse (nt. 5 kg kartulisalati) jaoks vajalikud toiduained.